<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\houtai\xiaowu\xiaowu\public/../application/admin\view\shop\steptwo.html";i:1568281850;s:74:"E:\houtai\xiaowu\xiaowu\public/../application/admin\view\index\header.html";i:1567735110;s:74:"E:\houtai\xiaowu\xiaowu\public/../application/admin\view\index\footer.html";i:1567735110;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <div class="pic-more">
                                <ul class="pic-more-upload-list" id="slide-pc-priview">
                                    ...
                                    <li class="item_img">
                                        ...
                                        <img src="__PUBLIC__/<?php echo $items; ?>" class="img" style="height: 80px;width:100px;" >
                                        <input type="hidden" name="goods_img_more[]" value="<?php echo $items; ?>" />
                                    </li>
                    ...
                    <table class="layui-table" style="margin-left: 111px;width: 85%;">
                        ...
                        <tr class="tr">
                            ...
                            <td class="gs_img" data-src="<?php echo $na['gs_img']; ?>">
                                <img style="width: 80px;height: 65px;" src="<?php echo $na['gs_img']; ?>"/>
                            </td>
