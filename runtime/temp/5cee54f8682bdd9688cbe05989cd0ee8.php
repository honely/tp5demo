...
<form class="layui-form" id="specForm" style="margin-top: 20px;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="hidden" name="gs_goods_id" value="<?php echo $g_id; ?>" class="layui-input">
        </div>
    </div>
